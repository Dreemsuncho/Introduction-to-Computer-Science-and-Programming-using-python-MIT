...
class Message(object):
    def __init__(self, text):
        ...
        self.valiid_words = load_words(WORDLIST_FILENAME)
    ...
    def build_shift_dict(self, shift):
        ...
        shift_dict = {}
        for n in range(26):
            decoded_char = string.ascii_lowercase[n]
            encoded_char = string.ascii_lowercase[(n + shift) % 26]

            shift_dict[decoded_char] = encoded_char
            shift_dict[decoded_char.upper()] = encoded_char.upper()
    ...
    def apply_shift(self, shift):
        ...
        for ch in decrypted_message:
            if ch.strip(" !@#$%^&*()-_+={}[]|\:;'<>?,./\"") != '':
                encrypted_message_chars.append(shift_dict[ch])
            else:
                encrypted_message_chars.append(ch)

        self.message_text = ''.join(encrypted_message_chars)
        return self.message_text
...
class PlaintextMessage(Message):
    ...
    def change_shift(self, shift):
        ...
        Returns: nothing
        '''
        self.apply_shift(26 - self.shift)
        self.shift = shift
...
if __name__ == '__main__':
    ...
    # test cases
    plaintext = PlaintextMessage('a', 2)
